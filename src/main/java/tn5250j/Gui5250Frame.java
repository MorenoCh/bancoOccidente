...
import tn5250j.event.*;
import tn5250j.gui.ButtonTabComponent;
import tn5250j.interfaces.ConfigureFactory;
import tn5250j.interfaces.GUIViewInterface;
import tn5250j.tools.GUIGraphicsUtils;
...
/**
 * This is the main {@link JFrame}, which contains multiple tabs.
 *
...
SessionJumpListener {
	...
	public void stateChanged(ChangeEvent e) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#addSessionView(java.lang.String, tn5250j.SessionGUI)
	  */
	 @Override
	public void addSessionView(final String tabText, final SessionPanel sesspanel) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.event.TabClosedListener#onTabClosed(int)
	  */
	 @Override
	public void onTabClosed(int tabToBeClosed) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#removeSessionView(tn5250j.SessionGUI)
	  */
	 @Override
	public void removeSessionView(SessionPanel targetSession) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#getSessionViewCount()
	  */
	 @Override
	public int getSessionViewCount() {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#getSessionAt(int)
	  */
	 @Override
	public SessionPanel getSessionAt( int index) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#onSessionChanged(tn5250j.event.SessionChangeEvent)
	  */
	 @Override
	public void onSessionChanged(SessionChangeEvent changeEvent) {
	 ...
	 /* (non-Javadoc)
	  * @see tn5250j.interfaces.GUIViewInterface#containsSession(tn5250j.SessionGUI)
	  */
	 @Override
