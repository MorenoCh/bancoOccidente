 ...
 *
 */
package tn5250j.encoding.builtin;
...
public abstract class CodepageConverterAdapter implements ICodepageConverter {
	...
	/* (non-Javadoc)
	 * @see tn5250j.cp.ICodepageConverter#init()
	 */
	...
	/* (non-Javadoc)
	 * @see tn5250j.cp.ICodepageConverter#uni2ebcdic(char)
	 */
	...
	/* (non-Javadoc)
	 * @see tn5250j.cp.ICodepageConverter#ebcdic2uni(int)
	 */
