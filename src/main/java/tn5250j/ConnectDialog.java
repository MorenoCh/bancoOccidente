...
import tn5250j.gui.SortTableModel;
import tn5250j.gui.TN5250jMultiSelectList;
import tn5250j.interfaces.ConfigureFactory;
import tn5250j.interfaces.OptionAccessFactory;
import tn5250j.tools.AlignLayout;
import tn5250j.tools.DESSHA1;
...
public class ConnectDialog extends JDialog implements ActionListener, ChangeListener, TN5250jConstants {
   ...
   private void createEmulatorOptionsPanel() {
      ...
      hideTabBar.addItemListener(new ItemListener() {
      ...
      showMe.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
      ...
      lastView.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
   ...
   private void createLoggingPanel() {
      ...
      intOFF.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
      ...
      intWARN.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
      ...
      intERROR.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
      ...
      intFATAL.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
      ...
      intConsole.addItemListener(new ItemListener() {
         public void itemStateChanged(ItemEvent e) {
