 ...
 *
 */
package tn5250j.tools;

import tn5250j.SessionConfig;
import tn5250j.SessionPanel;
import tn5250j.event.FTPStatusEvent;
import tn5250j.event.FTPStatusListener;
import tn5250j.framework.tn5250.tnvt;
import tn5250j.gui.GenericTn5250JFrame;
import tn5250j.gui.TN5250jFileChooser;
import tn5250j.gui.TN5250jFileFilter;
import tn5250j.mailtools.SendEMailDialog;
import tn5250j.sql.AS400Xtfr;
import tn5250j.tools.filters.XTFRFileFilter;
...
//	}
		...
		try {
			...
			/*SqlWizard wizard =
				new SqlWizard(
					...
					new String(password.getPassword()));*/
			int a=1;//OAC NL
			//wizard.setQueryTextArea(queryStatement);//OAC Com
	...
	private void initXTFRInfo(Properties XTFRProps) {
		...
		queryWizard.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				startWizard();
			}
		});
