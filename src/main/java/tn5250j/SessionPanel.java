...
SessionListener {
	...
	public void actionSpool() {
		...
		try {
			tn5250j.spoolfile.SpoolExporter spooler =
				new tn5250j.spoolfile.SpoolExporter(session.getVT(), this);
	...
	public synchronized void addSessionJumpListener(SessionJumpListener listener) {
		...
		if (listeners == null) {
			listeners = new Vector<SessionJumpListener>(3);
		}
	...
	public synchronized void addEmulatorActionListener(EmulatorActionListener listener) {
		...
		if (actionListeners == null) {
			actionListeners = new Vector<EmulatorActionListener>(3);
		}
	...
	/**
	 * @return
	 * @see Session5250#getSessionName()
	 */
